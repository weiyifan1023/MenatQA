...
print(instruction)
prompt_disturbance = 'Context: Elon Musk is a business magnate and investor. He is the new boss and CEO of Twitter now.\n Question:  Who is the CEO of Twitter now? \n answer:'
...
class LLMs_Model:
    ...
    def load_model(self, model_name_or_path: str = "EleutherAI/gpt-neox-20b", llm_device=LLM_DEVICE):
        ...
        if torch.cuda.is_available() and llm_device.lower().startswith("cuda"):
            self.model = AutoModelForCausalLM.from_pretrained(model_name_or_path, device_map="auto").half()
...
llm_model_dict = llm_model_dict  # custom llm dict
